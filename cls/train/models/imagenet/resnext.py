...
def resnext101(baseWidth, cardinality, num_classes):
    """
    Construct ResNeXt-101.
    """
    model = ResNeXt(baseWidth, cardinality, [3, 4, 23, 3], num_classes)
    return model


def resnext152(baseWidth, cardinality, num_classes):
    """
    Construct ResNeXt-152.
    """
    model = ResNeXt(baseWidth, cardinality, [3, 8, 36, 3], num_classes)
    return model
