...
def th_affine2d(x, matrix, mode='bilinear', center=True):
    ...
    #print('new coords value',new_coords[1:2,255,:])
    ...
    # print('new_coords',new_coords.shape)
...
def th_nearest_interp2d(input, coords):
    ...
    #print('x_ix size',x_ix.shape)
    #print('y_ix',y_ix.shape)

    input_flat = input.view(input.size(0),-1)

    #print('input_flat',input_flat.shape)
    #print('x_ix add y_ix',x_ix.add(y_ix).shape)
