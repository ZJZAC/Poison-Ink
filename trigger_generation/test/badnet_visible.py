...
def main():
    ...
    with torch.no_grad():
        ...
        # for i in range (imgNum):
            ...
            bad_img = copy.deepcopy(cover_B)
            channels, width, height = bad_img.shape[1:]
            # bad_img[:, :, width-3, height-3] = 1
            # bad_img[:, :, width-3, height-2] = 1
            # bad_img[:, :, width-2, height-3] = 1
            # bad_img[:, :, width-2, height-2] = 1

            bad_img[:, :, width-3, height-3] = 0
            bad_img[:, :, width-2, height-3] = 0
            bad_img[:, :, width-1, height-3] = 1
            bad_img[:, :, width-3, height-2] = 0
            bad_img[:, :, width-2, height-2] = 1
            bad_img[:, :, width-1, height-2] = 0
            bad_img[:, :, width-3, height-1] = 1
            bad_img[:, :, width-2, height-1] = 0
            bad_img[:, :, width-1, height-1] = 1
